                ...
                <div class="box-footer">
                    ...
                    <div class="box-tools pull-right">
                        <ul class="pagination">
                            ...
                            <li>
                                <a href="${pageContext.request.contextPath}/user/list?page=${pageInfo.prePage}&size=${pageInfo.pageSize}">
                                    上一页</a>
                            </li>
                            <c:forEach begin="1" end="${pageInfo.pages}" var="pageNum" step="1">
                                <li>
                                    <a href="${pageContext.request.contextPath}/user/list?page=${pageNum}&size=${pageInfo.pageSize}">
                                            ${pageNum}</a>
                                </li>
                            </c:forEach>
                            <li>
                                <a href="${pageContext.request.contextPath}/user/list?page=${pageInfo.nextPage}&size=${pageInfo.pageSize}">
                                    下一页</a></li>
                            <li>
...
<script type="text/javascript">
    function changePageSize() {
        ...
        //向服务器发送请求，改变没页显示条数
        location.href = "${pageContext.request.contextPath}/user/list?page=1&size="
            + pageSize;
    }
